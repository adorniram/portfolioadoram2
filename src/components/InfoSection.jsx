...
function InfoSection() {
  return (
    <section className="py-24 px-6 bg-gradient-to-b from-gray-50 to-white dark:from-gray-800 dark:to-gray-900" id="competences">
          ...
          {timelineData.map((item, i) => (
            <div key={i} className="flex flex-col">
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all hover:-translate-y-1 h-full">
                ...
                <h3 className="text-2xl font-bold mb-3 text-gray-800 dark:text-gray-100">{item.title}</h3>
                <p className="text-gray-600 dark:text-gray-300 mb-3">{item.organization}</p>
                <p className="text-gray-700 dark:text-gray-200 mb-4 leading-relaxed">{item.description}</p>
